...
построить кофейня - построить бизнес (1 час)
улучшить ID - улучшить бизнес (2 часа)
завершить стройку - завершить строительство
...
майнинг - собрать доход с майнинга
...
чат закрой - закрыть чат
чат открой - открыть чат
...
print(f"CommandDispatcher: 120+ команд")